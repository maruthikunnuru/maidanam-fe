export class UserGroupModel {
    ...
    constructor(userId: number, userName: string, firstName: string, lastName: string,
                displayName: string, emailId: string, groupId: number, group: number,
                referenceCd: string, totalCoins: number, totalLoan: number,
                effectiveCoins: number, userRole: string) {
        this.userId = userId;
